...
const SearchBox = () => {
  return (
    <div className=" bg-white rounded-1g p-8 grid grid-cols-1 md: grid-cols-2 1g:grid-cols-3 xl:grid-cols-4 items-center justify-center gap-8 mt-4 sm:mt-12 w-[95%] sm:w-[80%] " >
      {/* first search input */}
      <div className="flex items-center space-x-6">
      <FaMap className="w-6 h-6 text-blue-600" />
      <div>
      <p className="text-lg font-medium mb-[e.2rem]">Location</p>
...
<input type="date" className="outline-none border-none" />
 ...
 <div>
  ...
  <p className="text-base font-normall"> Guest 1 Room</p>
  </div>
 </div>
    </div>
  )
